...
- Все числа в CSV-файлах совпадают с числами, приведёнными в тексте ВКР `masters_thesis.tex` (приложения А-Е). При расхождении приоритет - за данными в этой папке (они получены непосредственно из ноутбуков, текст ВКР цитирует их).
